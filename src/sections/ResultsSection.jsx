      ...
      <div className="result-section">
        ...
        {showWordFreq && (
          <div className="image-gallery">
            ...
            <img className="result-image" src="/visuals/top_15_words_analysis_subreddits_lemmatized_text.png" alt="Top Words Subreddits" />
            <img className="result-image" src="/visuals/top_15_words_analysis_threads_lemmatized_text.png" alt="Top Words Threads" />
          </div>
        )}
      </div>
      ...
      <div className="result-section">
        ...
        {showSentiment && (
          <div className="image-gallery">
            ...
            <img className="result-image" src="/visuals/subreddit_sentiment_comparison.png" alt="Subreddit Sentiment" />
            <img className="result-image" src="/visuals/thread_sentiment_comparison.png" alt="Thread Sentiment" />
            <img className="result-image" src="/visuals/category_sentiment_comparison.png" alt="Category Sentiment" />
          </div>
        )}
      </div>
      ...
      <div className="result-section">
        ...
        {showTopics && (
          <div className="image-gallery">
            ...
            <img className="result-image" src="/visuals/topic_distribution_heatmap.png" alt="Topic Heatmap" />
            <img className="result-image" src="/visuals/topic_1_barplot.png" alt="Topic 1 Words" />
            <img className="result-image" src="/visuals/topic_2_barplot.png" alt="Topic 2 Words" />
            <img className="result-image" src="/visuals/coherence_vs_num_topics.png" alt="Coherence vs Topics" />
          </div>
        )}
      </div>
      ...
      <div className="result-section">
        ...
        {showMentions && (
          <div className="image-gallery">
            ...
            <img className="result-image" src="/visuals/category_adhd_mention_rate.png" alt="ADHD Mention Rate by Category" />
            <img className="result-image" src="/visuals/sentiment_vs_adhd_subreddits.png" alt="Sentiment vs ADHD Mentions Subreddits" />
            <img className="result-image" src="/visuals/sentiment_vs_adhd_threads.png" alt="Sentiment vs ADHD Mentions Threads" />
          </div>
        )}
      </div>
      ...
      <div className="result-section">
        ...
        {showPhrases && (
          <div className="image-gallery">
            ...
            <img className="result-image" src="/visuals/top_phrases_bar_chart.png" alt="Top Phrases Bar Chart" />
          </div>
        )}
      </div>
    </section>
